...
DynamicAABCollisionComponent::DynamicAABCollisionComponent(bool can_move, glm::vec3 sides) :
...
void DynamicAABCollisionComponent::checkCollisionWithSphere(SphereCollisionComponent *comp) {

}

void DynamicAABCollisionComponent::checkCollisionWithStaticAAB(StaticAABCollisionComponent *comp) {
